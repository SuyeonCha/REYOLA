 ...
 * Generated at: 2018-06-21 13:34:37 UTC
...
public final class write_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("   \r\n");
      out.write("   if( !form.nickname.value )   // form 에 있는 name 값이 없을 때\r\n");
      out.write("   {\r\n");
      out.write("    alert( \"이름을 적어주세요\" ); // 경고창 띄움\r\n");
      out.write("    form.nickname.focus();   // form 에 있는 name 위치로 이동\r\n");
      out.write("    return;\r\n");
      out.write("   }\r\n");
      out.write("   \r\n");
      ...
      out.write("\t\t\t\t\t\t\t<td class=tt colspan=2>글쓰기</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=writer>작성자 <input type=text class=tw name=\"nickname\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=pass align=right>비밀번호 <input type=password\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=tw name=\"password\"><a class=pass_2> (수정, 삭제시 반드시\r\n");
      out.write("\t\t\t\t\t\t\t\t\t필요)</a></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=title colspan=2>제목 <input type=text class=wtt\r\n");
      out.write("\t\t\t\t\t\t\t\tname=\"title\" maxlength=\"30\"></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\trows=19 cols=83></textarea></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align=center colspan=2><input type=submit class=save\r\n");
      out.write("\t\t\t\t\t\t\t\tname=\"save\" value=\"등록\" OnClick=\"javascript:writeCheck();\"></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t</div>\r\n");
